...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Creativecoin.lnk" $INSTDIR\litecoin-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Creativecoin.lnk"
    Delete /REBOOTOK "$SMSTARTUP\Creativecoin.lnk"
