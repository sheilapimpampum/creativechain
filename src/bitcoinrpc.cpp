...
// Copyright (c) 2011-2012 The Creativecoin Developers
...
// Creativecoin: Return average network hashes per second based on last number of blocks.
...
void ThreadRPCServer2(void* parg)
{
    ...
    ip::tcp::endpoint endpoint(bindAddress, GetArg("-rpcport", 19038));
...
Object CallRPC(const string& strMethod, const Array& params)
{
    ...
    if (!d.connect(GetArg("-rpcconnect", "127.0.0.1"), GetArg("-rpcport", "19038")))
