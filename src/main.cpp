...
uint256 hashGenesisBlock("0xc6bff87f22592c2f2947495f690d9fdaa8bd01044e4af56a05d6a40c1739d23d");
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // CreativeCoin: 0.35 days
static const int64 nTargetSpacing = 15; // CreativeCoin: 15 seconds
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "The Art Coin - Comando Suricato & Entropy Factory";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1480827456;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085386666;
        ...
        assert(block.hashMerkleRoot == uint256("0x908885edfe582de1c2536b25b60b8dcc5ebbc96f791ba1c87f32f1390292ee63"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Creativecoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
